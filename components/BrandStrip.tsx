...
export default function BrandStrip({
  ...
  return (
    <section aria-labelledby="brands-title" className={className}>
      <div className="shell">
        ...
        */}
        <ul className="mt-12 grid grid-cols-2 gap-x-6 gap-y-10 md:mt-16 md:grid-cols-3 md:gap-x-10 md:gap-y-12 lg:grid-cols-4">
          {brands.map((brand) => (
