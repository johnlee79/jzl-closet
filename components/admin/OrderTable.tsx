  ...
  return (
    <div>
      ...
      {message ? (
        <p
          role="status"
          className={`mb-4 rounded-md px-3 py-2 text-[16px] ${
        ...
        {orders.length === 0 ? (
          ...
          */
          <div className="px-4 py-16 text-center">
            <p className="text-[16px] text-slate-500">조건에 맞는 주문이 없습니다.</p>
          ...
          <table className="w-full min-w-[1180px] border-collapse text-[16px]">
            <thead>
              <tr className="border-b border-slate-200 bg-slate-50 text-left text-[15px] text-slate-600">
                ...
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">주문번호</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">주문일시</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">주문자</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">상품</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 text-right font-medium">결제금액</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">결제수단</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">현금영수증</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">상태</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">송장</th>
                <th scope="col" className="whitespace-nowrap px-3 py-2 font-medium">관리</th>
              </tr>
            </thead>
            <tbody>
              {orders.map((order) => (
