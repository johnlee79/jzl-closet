  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-5">
      ...
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">가입 환영 문구</h2>
        ...
        <div className="mt-4 flex flex-col gap-4">
          <div>
            ...
            />
            <p className="mt-1 rounded-md bg-slate-50 px-3 py-2 text-[13px] leading-relaxed text-slate-700">
              미리보기 —{' '}
      ...
      {/* ── 적립 안내 문구 ────────────────────────────── */}
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">적립 안내 문구</h2>
        <p className="mt-1 text-[13px] leading-relaxed text-slate-500">
      ...
      {/* ── 상단 띠배너 ───────────────────────────────── */}
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">상단 띠배너</h2>
        <p className="mt-1 text-[13px] leading-relaxed text-slate-500">
        ...
        {form.ribbon.text.trim() ? (
          <div className="mt-4">
            ...
            <div
              className={`flex min-h-[38px] items-center justify-center px-4 text-[13px] tracking-[0.06em] ${
      ...
      <p className="rounded-md bg-slate-50 px-4 py-3 text-[13px] leading-relaxed text-slate-700">
        이벤트 공지와 팝업은{' '}
