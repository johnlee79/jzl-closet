...
function RuleRow({
  ...
  return (
    <div className="flex flex-wrap items-start gap-4 border-b border-slate-100 py-4 last:border-b-0">
      <label className="flex w-[220px] shrink-0 items-center gap-2 text-[14px] text-slate-800">
        <input
          type="checkbox"
  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-5">
      ...
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">포인트 적립</h2>
      ...
      {/* ── 사용 ──────────────────────────────────────── */}
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">포인트 사용</h2>
      ...
      {/* ── 리뷰 태그 ─────────────────────────────────── */}
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">리뷰 긍정 태그</h2>
        <p className="mt-1 text-[13px] leading-relaxed text-slate-500">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-3">
          ...
          <span className="text-[13px] text-slate-500">{tags.length}개</span>
        </div>
