  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">현재 적용된 파비콘</h2>
        ...
        <div className="mt-4 flex flex-wrap items-start gap-6">
          ...
          <div>
            ...
            <div className="inline-flex max-w-[240px] items-center gap-2 rounded-t-md border border-slate-300 border-b-0 bg-slate-50 px-3 py-2">
              ...
              <span className="truncate text-[13px] text-slate-700">{store.name}</span>
            </div>
          </div>
        ...
        {branding.source ? (
          <p className="mt-4 break-all text-[12px] text-slate-500">
      ...
      {/* ── 새 파비콘 올리기 ───────────────────────────── */}
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">새 파비콘 올리기</h2>
