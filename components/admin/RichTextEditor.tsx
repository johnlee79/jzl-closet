...
export default function RichTextEditor({
  ...
  const toolButton =
    'rounded border border-slate-300 bg-white px-2.5 py-1.5 text-[13px] text-slate-700 hover:bg-slate-50';
  ...
  return (
    <div className="rounded-md border border-slate-300 bg-white">
      ...
      <div
        ...
        className="min-h-[140px] p-3 text-[14px] leading-[1.9] text-slate-900 outline-none empty:before:text-slate-400 empty:before:content-[attr(data-placeholder)]"
      />
    </div>
  );
}
