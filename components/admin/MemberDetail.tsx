  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="admin-card flex flex-wrap items-center justify-between gap-3 p-4 md:p-5">
        <div>
          <h1 className="text-[20px] font-semibold text-slate-900">{profile.name}</h1>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-[1fr_320px]">
        <div className="flex flex-col gap-5">
          ...
          <form onSubmit={save} className="admin-card p-4 md:p-5">
            ...
            <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                />
                <p className="mt-1 text-[12px] text-slate-500">회원에게는 보이지 않습니다.</p>
              </div>
            </div>
          ...
          <section className="admin-card p-4 md:p-5">
            ...
            {orders.length === 0 ? (
              <p className="mt-4 text-[13px] text-slate-500">주문 내역이 없습니다.</p>
            ) : (
        ...
        <aside className="flex flex-col gap-5">
          <section className="admin-card p-4 md:p-5">
            <h2 className="text-[16px] font-semibold text-slate-900">약관 동의</h2>
          ...
          <section className="admin-card p-4 md:p-5">
            <h2 className="text-[16px] font-semibold text-slate-900">계정</h2>
