...
export default function StoreSettingsForm({ initial }: { initial: StoreSettings }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">브랜드 소개 (3문장)</h2>
      ...
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">고객 응대</h2>
      ...
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[16px] font-semibold text-slate-900">사업자 정보</h2>
        <p className="mt-1 text-[13px] text-slate-500">
