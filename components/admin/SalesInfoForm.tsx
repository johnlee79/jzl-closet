...
function Field({
  ...
  return (
    <div>
      ...
      />
      {hint ? <p className="mt-1 text-[14px] leading-relaxed text-slate-500">{hint}</p> : null}
    </div>
  );
}
  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-5">
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[18px] font-semibold text-slate-900">배송</h2>
      ...
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[18px] font-semibold text-slate-900">교환 · 반품</h2>
      ...
      <section className="admin-card p-4 md:p-5">
        ...
        <dl className="mt-4 grid grid-cols-1 gap-2 text-[15px] sm:grid-cols-2">
