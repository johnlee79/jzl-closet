...
/**
 * ============================================================
 * ** 지금은 쓰지 않습니다 — 지우지 마세요 (2026-08-26)
 * ============================================================
 *
 * ** 어디에서도 부르지 않습니다. 일부러 남겨 둔 파일입니다.
 *   하는 일이 사이드바의 숫자 갱신과 겹쳐서 그쪽으로 합쳤습니다.
 *   components/admin/AdminShell.tsx 가 30초마다 /api/admin/badges 를
 *   부르고, 그 안의 isAdmin() 이 여기서 하던 getUser() 를 똑같이 합니다.
 *   타이머가 두 개 돌 이유가 없었습니다.
 *
 * ** 되돌리려면 app/admin/(dashboard)/layout.tsx 에서
 *   <AdminSessionKeeper /> 한 줄을 되살리면 됩니다.
 *   그쪽 파일에 그 자리와 이유를 적어 두었습니다.
 *   짝이 되는 주소 app/api/admin/session/route.ts 도 그대로 살아 있습니다.
 *
 * * 아래는 이 파일을 만들 때의 설명입니다. 되돌릴 때 필요합니다.
 *
 * ============================================================
