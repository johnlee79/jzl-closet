            ...
            >
              <div className="flex flex-wrap items-center gap-x-2 gap-y-2 px-4 py-3 md:flex-nowrap">
                ...
                <span className="flex-1">
                  ...
                  <span className="ml-2 text-[12px] text-slate-500">/{brand.slug}</span>
                  {brand.tagline ? (
                    <span className="block text-[12px] text-slate-500">{brand.tagline}</span>
                  ) : null}
                </span>

                <span className="w-[150px] text-[13px] text-slate-700">{brand.name}</span>
