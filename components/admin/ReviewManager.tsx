    ...
    <div>
      ...
      <section className="admin-card mb-4 p-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h2 className="text-[15px] font-semibold text-slate-900">리뷰 직접 등록</h2>
          ...
          <ul>
            {reviews.map((review) => (
              ...
              >
                ...
                {review.tags.length > 0 ? (
                  <ul className="mt-2 flex flex-wrap gap-1.5">
                    {review.tags.map((tag) => (
                      <li
                        key={tag}
                        className="rounded bg-slate-100 px-2 py-0.5 text-[12px] text-slate-700"
                      >
                        {tag}
                      </li>
                    ))}
                ...
                <p className="mt-2 whitespace-pre-line text-[14px] leading-relaxed text-slate-800">
                  {review.content}
                </p>
                ...
                {review.adminReply && replying !== review.id ? (
                  <div className="mt-3 rounded-md bg-slate-50 p-3">
                    <p className="text-[12px] font-medium text-slate-600">판매자 답변</p>
                    <p className="mt-1 whitespace-pre-line text-[13px] leading-relaxed text-slate-800">
                      {review.adminReply}
                    </p>
                  </div>
                ) : null}
      ...
      <p className="mt-4 text-[13px] text-slate-500">전체 {total}건</p>
    </div>
  );
}
