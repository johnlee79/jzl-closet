  ...
  return (
    <div className="flex flex-col gap-5">
      <section className="admin-card p-4 md:p-5">
        <h2 className="text-[18px] font-semibold text-slate-900">자동 슬라이드</h2>
      ...
      <section className="admin-card p-4 md:p-5">
        ...
        {banners.length === 0 ? (
          <p className="mt-4 rounded-md bg-slate-50 px-3 py-4 text-[15px] leading-relaxed text-slate-600">
              ...
              >
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <span
                    ...
                    title="끌어서 순서 변경"
                    className="cursor-move select-none text-[16px] font-semibold text-slate-700"
                  >
                    ≡ 배너 {index + 1}
                  </span>
