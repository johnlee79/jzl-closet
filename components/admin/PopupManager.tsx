...
function PopupForm({
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
        ...
        <div>
          ...
          <input
            ...
            className="admin-input"
          />
          <p className="mt-1 text-[14px] text-slate-500">그날 0시부터 (한국시간)</p>
        </div>
        <div>
          ...
          <input
            ...
            className="admin-input"
          />
          <p className="mt-1 text-[14px] text-slate-500">그날 밤 12시까지 (한국시간)</p>
        </div>
      ...
      <p className="mt-3 rounded-md bg-slate-50 px-3 py-2 text-[14px] leading-relaxed text-slate-600">
          ...
          <div className="mt-3 rounded-md border border-slate-200 bg-slate-100 p-6">
            ...
            >
              {draft.imageUrl ? (
                ...
                <div className="p-5">
                  <p className="text-[18px] font-medium text-slate-900">
                    {draft.title || '(제목 없음)'}
                  </p>
                  {draft.content ? (
                    <div
                      className="mt-2 text-[16px] leading-relaxed text-slate-700"
              ...
              <div className="flex items-center justify-between border-t border-slate-200 text-[14px] text-slate-500">
            ...
            {popups.map((popup) => (
              <li key={popup.id} className="border-b border-slate-200 last:border-b-0">
                <div className="flex flex-wrap items-center gap-x-3 gap-y-2 px-4 py-3">
                  <span className="w-10 text-[15px] tabular-nums text-slate-400">
                    {popup.displayOrder}
                  </span>
