  ...
  return (
    <div>
      ...
      <div className="mt-1 flex items-start justify-between gap-3">
        <p id={`${id}-help`} className="text-[12px] leading-relaxed text-slate-500">
...
export function OriginField({
  ...
  return (
    <div>
      ...
      />
      {fromBrand ? (
        <p id={`${id}-auto`} className="mt-1 text-[12px] leading-relaxed text-amber-700">
  ...
  return (
    <div>
      ...
      {country ? (
        <div
          id={`${id}-warn`}
          className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-[12px] leading-relaxed text-amber-700"
        >
          <span>
          ...
          <button
            ...
            className="admin-btn min-h-0 px-2 py-0.5 text-[12px]"
          >
