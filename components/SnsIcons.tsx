...
/**
 * 모든 아이콘이 쓰는 기본 크기. 한 줄에 섞여도 눈높이가 맞습니다.
 *
 * ★ 실제로 화면에 나오는 크기는 여기가 아니라 app/globals.css 의
 *   .sns-icon svg 가 정합니다. (24px, 큰 자리는 32px)
 *   속성보다 CSS 가 세서, 이 값은 아무 데도 안 감싸였을 때의 기본값일 뿐입니다.
 *   덕분에 아이콘마다 크기 prop 을 뚫지 않아도 자리에 따라 커집니다.
 * ★ viewBox 는 반드시 24 기준으로 맞춰 주세요. 그림 좌표가 전부 여기에 걸려 있습니다.
 */
