...
export default async function AdminReferralReviewPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-[1000px]">
      <h1 className="text-[20px] font-semibold text-slate-900">의심 건 검토</h1>
      ...
      <div className="admin-card mt-5 p-5">
        <h2 className="text-[15px] font-semibold text-slate-900">판단 기준</h2>
        <ul className="mt-3 flex list-disc flex-col gap-2 pl-5 text-[13px] leading-relaxed text-slate-600">
          <li>
