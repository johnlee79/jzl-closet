...
export default function ShopError({
   ...
   *
   * ★★ 전에는 여기서 아무것도 안 그렸습니다. 그런데 **빈 화면도 고장으로
   *   보입니다.** 손님이 뭘 잘못 눌렀나 싶어 뒤로가기를 누르면 로그인이
   *   진짜로 중단됩니다. 그래서 "지금 옮기는 중" 이라고 말해 줍니다.
   *
   * ★ markLeaving() 을 부른 경우에만 참입니다. 진짜 고장은 아래 안내 화면이
   *   그대로 다 나옵니다. 갈라지는 기준은 이 한 줄뿐입니다.
   */
  if (isLeaving()) return <LeavingScreen inShell />;
