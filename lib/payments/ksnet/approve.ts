 ...
 *   KSNET 확인 (2026-08-24): 결제 키로 다시 조회할 수 있는 기간은 결제 이후
 *   대략 2일이며 결제 시간에 따라 일부 조정될 수 있습니다.
 *   ★ 예전 주석에는 "당일에 한해" 라고 적혀 있었습니다. 그 말의 출처는
 *     KSNET 문서가 아니라 우리가 쓴 작업 지시서(4a.md)였고, 사실이 아닙니다.
 *     그 문장 위에 자정 점검 cron 이 지어져 있었는데 함께 걷어냈습니다.
