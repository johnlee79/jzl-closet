...
> = {
  ...
  orderHero: {
    ...
    hint: '/order 맨 위입니다. 소제목이 큰 제목(h1)으로, 본문이 그 아래 안내 문단으로 나갑니다. 검색 결과의 제목·설명에도 이 값을 씁니다. 링크는 편집기의 링크 버튼으로 넣으세요.',
    path: '/order',
    blockLabel: '문단',
  },
  cartEmpty: {
    group: 'order',
    title: '장바구니가 비어 있을 때',
    hint: '장바구니에 담은 상품이 하나도 없을 때 그 자리에 나오는 안내입니다. 소제목이 굵은 첫 줄, 본문이 그 아래 설명입니다. 아래에 [전체 상품 보기] 버튼과 최근 본 상품이 이어집니다.',
    path: '/order',
    blockLabel: '문단',
  },
  cartPayment: {
  ...
  cartCopyNote: {
    group: 'order',
    title: '주문 내역 복사 안내',
    hint: '장바구니 오른쪽 요약 상자 맨 아래, [주문 내역 복사하기]·[카카오톡 문의] 버튼 밑에 나오는 한 줄입니다. 소제목은 쓰지 않습니다.',
    path: '/order',
    blockLabel: '문단',
  },
  order: {
    ...
    hint: '/order 페이지 아래쪽, 주문 절차 3단계 밑의 네모 상자 안입니다. ★ 결제 수단(무통장입금·카드) 자체는 여기 적지 마세요. 위 “결제 수단 안내” 한 곳에서만 관리합니다. 여기에는 입금 계좌 위치·자동취소·입금자명처럼 절차에 관한 것만 적습니다.',
    path: '/order',
    blockLabel: '항목',
  },
  notFound: {
