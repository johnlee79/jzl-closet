 ...
 *
 * ★★ 어디에 쓰나 — 새로 만드는 폼에만 씁니다.
 *   이미 있는 폼들은 각자 message 상태와 "저장 중…" 표시를 갖추고 있어
 *   잘 동작합니다. 다른 점은 성공 안내가 저절로 사라지느냐뿐입니다.
 *   그것 하나 때문에 운영 중인 폼 수십 개를 건드리면 얻는 것보다 잃을 위험이
 *   큽니다. 그래서 기존 폼은 그대로 두기로 했습니다.
 *   새 폼을 만들 때만 이 훅과 SaveFeedback 을 쓰세요.
 */
